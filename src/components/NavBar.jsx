  ...
  return (
    <header className="w-full px-4 md:px-16 py-8 font-medium ">
      ...
      <div>
        ...
        {isOpen && (
          <div class="absolute mt-4 z-10 border bg-white divide-y divide-gray-100 w-32 dark:bg-gray-700 dark:divide-gray-600">
            <Link
              href="/"
              class="text-gray-700 hover:bg-gray-700 hover:text-white block px-2 py-2 text-base font-medium">
              Home
            </Link>
