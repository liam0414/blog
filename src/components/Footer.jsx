        ...
        <div className="max-w-7xl mx-auto py-4 sm:px-6 lg:px-8 text-dark">
          <div className="grid grid-cols-1 md:grid-cols-7 gap-2 ">
            <div className="col-span-2">
              <input id="first" type="text" placeholder="first name" className="h-10 block w-full rounded-md pl-2" />
            </div>
            <div className="col-span-2">
              <input id="last" type="text" placeholder="last name" className="h-10 block w-full rounded-md pl-2" />
            </div>
            <div className="col-span-2">
              <input
                id="email"
            ...
            <div>
              <button type="submit" className=" py-2 px-6 bg-green-500 text-dark font-medium rounded-md shadow-md">
                Submit
              </button>
            </div>
          </div>
