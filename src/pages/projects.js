        ...
        {repos.map((repo, index) => (
          ...
          >
            <a href={repo.html_url}>
              <img className="w-full rounded-t-lg" src="/images/projects/devdreaming.jpg" alt="" />
            </a>
            <div className="p-5">
              <a href={repo.html_url}>
              ...
              {!repo.description && (
                <p className="mb-8 font-normal text-gray-700 dark:text-gray-400">No Description</p>
              )}
              <a
                href={repo.html_url}
