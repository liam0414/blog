...
import qr from "../public/images/qr-code.jpg";
...
If you like the content on this website and want to support me you can tip me using the QR code below.

<Image src={qr} width={200} height={210} />
